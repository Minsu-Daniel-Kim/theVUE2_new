...
import net.sourceforge.theVUE2.TakePhoto;
import net.sourceforge.theVUE2.ToastBoxer;
import net.sourceforge.theVUE2.CameraController.CameraController;
import net.sourceforge.theVUE2.CameraController.CameraController1;
import net.sourceforge.theVUE2.CameraController.CameraController2;
import net.sourceforge.theVUE2.CameraController.CameraControllerException;
import net.sourceforge.theVUE2.CameraController.CameraControllerManager;
import net.sourceforge.theVUE2.CameraController.CameraControllerManager1;
import net.sourceforge.theVUE2.CameraController.CameraControllerManager2;
import net.sourceforge.theVUE2.Preview.CameraSurface.CameraSurface;
import net.sourceforge.theVUE2.Preview.CameraSurface.MySurfaceView;
import net.sourceforge.theVUE2.Preview.CameraSurface.MyTextureView;
